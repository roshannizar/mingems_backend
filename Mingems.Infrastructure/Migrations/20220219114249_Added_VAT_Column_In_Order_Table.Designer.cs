...
namespace Mingems.Infrastructure.Migrations
{
    ...
    [Migration("20220219114249_Added_VAT_Column_In_Order_Table")]
    partial class Added_VAT_Column_In_Order_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mingems.Core.Models.Order", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Mingems.Core.Models.OrderLine", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Mingems.Core.SPModels.TopCustomers", b =>
                {
                    b.Property<string>("Email")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Mingems.Core.Models.Order", b =>
                {
                    b.HasOne("Mingems.Core.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Mingems.Core.Models.OrderLine", b =>
                {
                    b.HasOne("Mingems.Core.Models.Order", "Order")
                        .WithMany("OrderLines")
